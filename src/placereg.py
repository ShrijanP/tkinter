...
text2=Entry(window).place(x=200,y=50)
text.place(x=100,y=50)

D=Label(window,text="Last name",fg="brown")
text3=Entry(window).place(x=200,y=90)
D.place(x=100,y=90)


A=Label(window,text="Email",fg="brown")
text4=Entry(window).place(x=200,y=120)
A.place(x=100,y=120)

E=Label(window,text="Password",fg="brown")
text5=Entry(window,show="*").place(x=200,y=150)
E.place(x=100,y=150)

F=Label(window,text="Confirm Password",fg="brown")
text6=Entry(window,show="*").place(x=200,y=180)
F.place(x=100,y=180)
